...
#### some analysis on what word frequencies
data_journals %>% 
  mutate(frequency_prophet = length(gregexpr('(book of mormon)', text)))

text = c('hello my name is porter', 'pizza pie')
length(gregexpr('porter', text))

gregexpr('porter', text)
